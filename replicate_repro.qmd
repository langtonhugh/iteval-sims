...
This loads in the simulations created during the codecheck after executing `population.R` and `sim.R`. Note that to reduce computation time for the codecheck, the number of simulations was reduced from 500 to 50.

```{r, message = F, warning = F, fig.height = 5, echo = FALSE}
library(ggplot2)
library(patchwork)
library(stringr)
library(xtable)
